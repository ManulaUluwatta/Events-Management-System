<%-- 
    Document   : participantDashBoard
    Created on : Jan 30, 2020, 3:44:58 AM
  ...
  <div class="container-fluid">
    <ul class="nav navbar-nav">
        <li class="nav-item active">
          ...
          <li class="nav-item">
              <a class="nav-link" href="viewConference.jsp">View Conference <span class="sr-only">(current)</span></a>
          </li>
         
      
    </ul>
    <ul class="nav navbar-nav navbar-right">
      <li><a href="registerParticipant.html"><span class="glyphicon glyphicon-user"></span>Participant Register</a></li>
